    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (WasResized)
            {
                ...
                graphics.PreferredBackBufferWidth = res_width; //1920;

                graphics.PreferredBackBufferHeight = res_height; //1080;
        ...
        private void ShowExampleMenuFile()
        {
            ...
            if(ImGui.BeginMenu("Options"))
            {
                ...
                ImGui.BeginChild("child", new Vec2(0, 60), true);
                for (int i=0; i<10; i++)
                {
        ...
        unsafe private struct ImGuiDebugLog
        {
            ...
            public void Draw(string title)
            {
                ...
                ImGui.Separator();
                ImGui.BeginChild("scrolling", new Vec2(0, 0), false, ImGuiWindowFlags.HorizontalScrollbar);
        ...
        unsafe private struct ImGuiExampleAppConsole
        {
            ...
            public void Draw(string title)
            {
                ...
                ImGui.BeginChild("ScrollingRegion", new Vec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags.HorizontalScrollbar);
                if(ImGui.BeginPopupContextWindow())
                {
        ...
        private void DemoWindowWidgets()
        {
            ...
            if (ImGui.TreeNode("Basic"))
            {
                ...
                ImGui.InputTextWithHint("input text (w/ hint", "enter text here", str1, 10);
            ...
            if (ImGui.TreeNode("Images"))
            {
                ...
                for(int i=0; i<8; i++)
                {
                    ...
                    if(ImGui.ImageButton(my_tex_id, size, uv0, uv1, frame_padding, bg_col, tint_col2))
                    {
                        pressed_count += 1;
                    }
                    ImGui.PopID();
            ...
            if (ImGui.TreeNode("Text Input"))
            {
                ...
                if(ImGui.TreeNode("Password Input"))
                {
                    ...
                    ImGui.InputTextWithHint("password (w/ hint)", "<password>", password, (uint)64, ImGuiInputTextFlags.Password);
        ...
        private void DemoWindowLayout()
        {
            ...
            if (ImGui.TreeNode("Child windows"))
            {
                ...
                ImGui.BeginChild("ChildL", new Vec2(ImGui.GetWindowContentRegionWidth() * 0.5f, 260), false, window_flags);
                for (int i = 0; i<100; i++)
                {
                ...
                ImGui.BeginChild("ChildR", new Vec2(0, 260), true, window_flags_child2);
                ...
                ImGui.BeginChild("Red", new Vec2(200, 100), true, ImGuiWindowFlags.None);
                for (int n = 0; n < 50; n++)
                {
            ...
            if (ImGui.TreeNode("Scrolling"))
            {
                ...
                for (int i = 0; i<5; i++)
                {
                    ...
                    bool child_is_visible = ImGui.BeginChild(child_id, new Vec2(child_w, 200.0f), true, child_flags);
                    if(ImGui.BeginMenuBar())
                    {
                ...
                for(int i = 0; i<5; i++)
                {
                    ...
                    string child_id = names[i];
                    bool child_is_visible = ImGui.BeginChild(child_id, new Vec2(-100, child_height), true, child_flags);
                    if(scroll_to_off)
                    {
        ...
        private void DemoWindowMisc()
        {
            if(ImGui.CollapsingHeader("Inputs, Navigation & Focus"))
            {
                ...
                if(ImGui.TreeNode("Keyboard, Mouse & Navigation State"))
                {
                    ...
                    ImGui.Text("Mouse clicked:"); for (int i = 0; i < io.MouseDown.Count; i++) if (ImGui.IsMouseClicked(i)) { ImGui.SameLine(); ImGui.Text(i.ToString()); }
                    ImGui.Text("Mouse dblclick:"); for (int i = 0; i < io.MouseDown.Count; i++) if (ImGui.IsMouseDoubleClicked(i)) { ImGui.SameLine(); ImGui.Text(i.ToString()); }
                    ImGui.Text("Mouse released:"); for (int i = 0; i < io.MouseDown.Count; i++) if (ImGui.IsMouseReleased(i)) { ImGui.SameLine(); ImGui.Text(i.ToString()); }
                    ...
                    ImGui.Text("Keys pressed:"); for (int i = 0; i < io.KeysDown.Count; i++) if (ImGui.IsKeyPressed(i)) { ImGui.SameLine(); ImGui.Text(string.Format("{0} ({1})", i, i)); }
                    ImGui.Text("Keys release:"); for (int i = 0; i < io.KeysDown.Count; i++) if (ImGui.IsKeyReleased(i)) { ImGui.SameLine(); ImGui.Text(string.Format("{0} ({1})", i, i)); }
